...
A clean and minimal login form built with HTML, CSS, and JavaScript. This was created as a beginner front-end project to practice web development fundamentals.
